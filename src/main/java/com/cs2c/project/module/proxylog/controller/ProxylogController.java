package com.cs2c.project.module.proxylog.controller;
...
import com.cs2c.project.module.proxylog.service.IProxylogService;
 ...
 */
@Controller
@RequestMapping("/module/proxylog")
public class ProxylogController extends BaseController
{
    private String prefix = "module/proxylog";
	
	@Autowired
	private IProxylogService proxylogService;
	
	@RequiresPermissions("module:proxylog:view")
	@GetMapping()
	public String proxylog()
	{
	    return prefix + "/proxylog";
	}
	...
	*/
    ...
    {       
        return proxylogService.showlog();
    }
